...
- Name: slots.spec.ts >> Dog House payline проходит через измеренные центры ячеек
- Location: tests/e2e/slots.spec.ts:18:1
...
Locator: locator('.dogslot-payline-overlay[data-measured=\'true\']')
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('.dogslot-payline-overlay[data-measured=\'true\']')

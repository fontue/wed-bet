...
export const LEMONZA_CALCULATED_RTP =
  "Standard 95,77% · Lemon Boost 96,56% · покупка бонуса ≈99,57%";
...
export type LemonzaSymbolWeights = Record<LemonzaRegularSymbol, number> & {
  SCATTER: number;
};
...
export const LEMONZA_SYMBOL_META = Object.fromEntries(
  LEMONZA_SYMBOLS.map((symbol) => [symbol.id, symbol]),
) as Record<LemonzaRegularSymbol, LemonzaSymbolConfig>;

export const LEMONZA_GAME = {
  id: "sweet-lemonza",
  title: "Sweet Lemonza",
  subtitle: "La Dolce Vita Spins",

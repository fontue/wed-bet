export type DogHouseRegularSymbol =
  | "BRUNO"
  | "BELLA"
  | "PUG"
  | "DACHSHUND"
...
export interface DogHouseRoundResult {
  ...
  maxLineMultiplier: number;
  stickyWildCount: number;
  bestFreeSpin: number;
  maxWinCapped: boolean;
}
export interface DogHouseRng {

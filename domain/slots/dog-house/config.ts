...
export const DOG_HOUSE_GAME={
  id:"casa-degli-sposi",title:"Casa degli Sposi",subtitle:"Lucky Wedding Dogs",
  description:"Пять барабанов, двадцать линий и липкие домики-Wild во фриспинах.",
  minBet:DOG_HOUSE_BETS[0],mathVersion:DOG_HOUSE_MATH_VERSION,
} as const;

export const DOG_HOUSE_SYMBOLS:Array<{id:DogHouseRegularSymbol;title:string;payouts:[number,number,number]}>= [
...
export const DOG_HOUSE_SYMBOL_META=Object.fromEntries(DOG_HOUSE_SYMBOLS.map((item)=>[item.id,item])) as Record<DogHouseRegularSymbol,(typeof DOG_HOUSE_SYMBOLS)[number]>;
...
export const DOG_HOUSE_BASE_WEIGHTS:Record<DogHouseRegularSymbol,number>={
  BRUNO:280,BELLA:320,PUG:400,DACHSHUND:440,COLLAR:600,BONE:680,A:800,K:800,Q:960,J:960,TEN:960,
};
export const DOG_HOUSE_FREE_WEIGHTS:Record<DogHouseRegularSymbol,number>={
  BRUNO:280,BELLA:320,PUG:360,DACHSHUND:400,COLLAR:560,BONE:640,A:760,K:760,Q:880,J:880,TEN:880,
};
...
export const isDogHouseRegular=(symbol:DogHouseSymbol):symbol is DogHouseRegularSymbol=>symbol!=="WILD"&&symbol!=="BONUS";
